...
Adapted Atsushi Sakai (@Atsushi_twi) and Guillaume Jacquenot (@Gjacquenot) simulation to fit 4 point bezier curve path finding
...
if __name__ == '__main__':
    ...
    x_list, y_list = gb.generate_bezier_pathing(-20, 20, 0, 14)
    run(x_list, y_list)
